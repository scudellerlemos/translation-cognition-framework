...
| **A prova** | Jogo **100% traduzido**: 16 capítulos, 146 cenas, ~45.100 linhas, **round-trip byte-idêntico**, **~R$ 338,46** (R$ 0 desperdiçado), pt-BR renderizando in-game. |
...
Gasto real acumulado: **~R$ 338,46** (Sonnet R$ 260,17 · Opus R$ 40,01 · Haiku R$ 38,28), **R$ 0 desperdiçado** (medido
