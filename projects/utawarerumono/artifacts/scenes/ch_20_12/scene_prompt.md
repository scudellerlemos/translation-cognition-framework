# Cena ch_20_12 — pacote de traducao (11 linhas)
...
|---|---|---|
| 0x1de886 | 26 | Near the western border... |
| 0x1de8a1 | 28 | Another battle is unfolding. |
| 0x1de8be | 47 | Once again, the Uzurushan army overwhelms the\n |
| 0x1de8ee | 32 | Yamatan army with sheer numbers. |
| 0x1de90f | 43 | The difference approaches ten soldiers of\n |
| 0x1de93b | 33 | Uzurusha for every one of Yamato. |
| 0x1de95d | 50 | Not only this, the Uzurushan army has seized the\n |
| 0x1de990 | 21 | advantage in terrain. |
| 0x1de9a6 | 48 | The old commander of the Uzurushan army stands\n |
| 0x1de9d7 | 42 | high atop a cliff, surveying the Yamatan\n |
| 0x1dea02 | 11 | fortress... |

## 8. Formato de saida EXIGIDO
Escreva `translations_20_12.json` com a forma:
```json
{ "lines": {
