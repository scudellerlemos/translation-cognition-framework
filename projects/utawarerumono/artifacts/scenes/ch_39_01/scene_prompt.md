# Cena ch_39_01 — pacote de traducao (2 linhas)
...
|---|---|---|---|---|
| Dream Arena | UI | Arena dos Sonhos | traduzir | none |
...
|---|---|---|
| 0x31da9a | 54 | {c5}Dream Arena{c-} has been added to the system menu. |
| 0x31dad1 | 44 | Dream Arena stages can be played repeatedly. |

## 8. Formato de saida EXIGIDO
Escreva `translations_39_01.json` com a forma:
```json
{ "lines": {
