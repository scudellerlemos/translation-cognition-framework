# Cena ch_21_08 — pacote de traducao (11 linhas)
...
|---|---|---|
| 0x22a091 | 45 | Several days pass in relative calm after we\n |
| 0x22a0bf | 22 | arrive back in Yamato. |
| 0x22a0d6 | 48 | We return to the rhythm of peace and busyness,\n |
| 0x22a107 | 46 | and the events in the ruins slowly fade into\n |
| 0x22a136 | 7 | memory. |
| 0x22a13e | 46 | Those nostalgic memories and our strange and\n |
| 0x22a16d | 48 | terrifying experiences gradually slip from our\n |
| 0x22a19e | 6 | minds. |
| 0x22a1a5 | 43 | Maybe I should just let it be, and forget\n |
| 0x22a1d1 | 43 | everything... The thought crosses my mind\n |
| 0x22a1fd | 14 | several times. |

## 8. Formato de saida EXIGIDO
Escreva `translations_21_08.json` com a forma:
```json
{ "lines": {
