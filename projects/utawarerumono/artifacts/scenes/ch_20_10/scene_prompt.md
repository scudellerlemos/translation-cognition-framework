# Cena ch_20_10 — pacote de traducao (8 linhas)
...
|---|---|---|
| 0x1ca88f | 49 | Uzurusha intends to ride Yamato's lifeline, the\n |
| 0x1ca8c1 | 49 | great river running through it, straight to its\n |
| 0x1ca8f3 | 8 | capital. |
| 0x1ca8fc | 47 | The flagging Yamatan army has only time for a\n |
| 0x1ca92c | 49 | hasty camp on the river's bank. A head-on clash\n |
| 0x1ca95e | 14 | is inevitable. |
| 0x1ca96d | 46 | The Uzurushan army, hesitant to lose more of\n |
| 0x1ca99c | 53 | their soldiers, decides to wait for reinforcements... |

## 8. Formato de saida EXIGIDO
Escreva `translations_20_10.json` com a forma:
```json
{ "lines": {
