"""test_tier_classifier_gate.py — cobre existence_gate (D5): T1 nunca aciona geracao, T2 e o
UNICO tier que aciona, T3 fica bloqueado. Formaliza o que discover.py ja fazia via if/elif."""
import sys
...
def test_existence_gate_t1_never_generates_and_points_to_reference():
...
def test_existence_gate_t2_is_only_tier_that_generates():
...
def test_existence_gate_t3_blocked_never_generates():
    evidence = {"file_count": 5, "families": {}, "magic_bytes": {}, "sample_encodings": {},
